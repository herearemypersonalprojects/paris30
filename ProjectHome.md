Paris 3.0 is a mobile application that integrates real-time and open data from different sources in order to recommend the services personalized for each traveler in Paris.
